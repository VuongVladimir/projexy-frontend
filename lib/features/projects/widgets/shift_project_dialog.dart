...
class ShiftProjectDialog extends StatefulWidget {
  final Project project;
  final VoidCallback onShifted;
  
  const ShiftProjectDialog({
    super.key,
  ...
  @override
  State<ShiftProjectDialog> createState() => _ShiftProjectDialogState();
}

class _ShiftProjectDialogState extends State<ShiftProjectDialog> {
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            // Preview
            if (_selectedDays != 0 && widget.project.startDate != null && widget.project.endDate != null) ...[
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${tr('current')}: ${_formatDateRange(widget.project.startDate!, widget.project.endDate!)}',
                    ...
                    Text(
                      '${tr('after_shift')}: ${_formatDateRange(
                        widget.project.startDate!.add(Duration(days: _selectedDays)),
                        widget.project.endDate!.add(Duration(days: _selectedDays)),
                      )}',
                      style: theme.textTheme.bodySmall?.copyWith(
  ...
  void _shift() {
    ProjectsService.shiftProject(
      ...
      onSuccess: () {
        ...
        widget.onShifted();
        showSnackBar(context, tr('project_shifted_successfully'));
      },
    );
  }
}
